{
  description = "Isolated GNOME 48, 49, and 50 extension testing";
      ...
      let
        ...
        mkNestedGnome =
          ...
          let
            ...
            targetExtension = targetPkgs.callPackage ../../package.nix { src = ../..; };
            launcher = targetPkgs.callPackage ../nested-gnome.nix {
              extension = targetExtension;
              xdpyinfo = targetPkgs.xdpyinfo or targetPkgs.xorg.xdpyinfo;
              inherit extensionUuid presentationMode shellMajorVersion;
            };
            check = targetPkgs.callPackage ../nested-gnome-check.nix {
              extension = targetExtension;
